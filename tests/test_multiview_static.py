...
class MultiViewStaticTests(unittest.TestCase):
    ...
    def test_naive_prompt_per_view_strategy_is_absent(self):
        ...
        self.assertEqual(runner.count("Invoke-AFCommand -Executable $ComfyRunner"), 1)
    ...
    def test_reference_quality_features_are_configurable(self):
        ...
        self.assertIn('reference-quality.log', runner)
        ...
        self.assertEqual(presets["defaultPreset"], "multiview-object")
